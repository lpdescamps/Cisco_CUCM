...
def newsdudp(client, udp, *args):
    print('Rebuilding the Speed Dials for ' + udp)
...
def newsdphone(client, phone, *args):
    print('Rebuilding the Speed Dials for ' + phone)
...
def main():
    ...
    for udp in udps:
        if getudp(axl, udp)['return']['deviceProfile']['speeddials'] is None:
            ...
            sdfull = [sd for sd in getudp(axl, udp)['return']['deviceProfile']['speeddials']['speeddial']]
            for sd in sddirn:
                if sd == RMSD:
                    rmsd = [sd for sd in getudp(axl, udp)['return']['deviceProfile']['speeddials']['speeddial']
                            if sd['dirn'] != RMSD]
                    print(udp)
                    print(sdfull)
                    newsdudp(axl, udp, rmsd)
                    break
                else:
                    pass
    ...
    for phone in phones:
        if getphone(axl, phone)['return']['phone']['speeddials'] is None:
            ...
            sdfull = [sd for sd in getphone(axl, phone)['return']['phone']['speeddials']['speeddial']]
            for sd in sddirn:
                if sd == RMSD:
                    rmsd = [sd for sd in getphone(axl, phone)['return']['phone']['speeddials']['speeddial'] if
                            sd['dirn'] != RMSD]
                    print(phone)
                    print(sdfull)
                    newsdphone(axl, phone, rmsd)
                    break
                else:
                    pass
